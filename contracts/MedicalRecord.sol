...
mapping(string => Consent[]) public consentLog;
    ...
    // --- NEW: Event for tracking actions ---
    event Action(address indexed user, string action, uint256 timestamp);
...
*/
    function addPrescription(
      ...
      cid: _cid,
        ...
        emit Action(msg.sender, "Prescription Added", block.timestamp);
}
    
    // --- NEW: Function to Grant or Revoke Consent ---
    /**
     * @dev Adds a new consent entry to the patient's log.
Can be used for granting or revoking.
     * This is a "write" operation and will cost gas to execute.
*/
    function manageConsent(
      ...
      duration: _duration,
        ...
        emit Action(msg.sender, "Consent Managed", block.timestamp);
}
